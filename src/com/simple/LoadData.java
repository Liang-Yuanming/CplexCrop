...
//	public static String FILENAMES[]={"simple.xls","simple2.xls"};
...
//	public static String BEGINDATE[]={"2015/07/01","2014/07/01"};
...
//					int a=Common.searchA(aCell.getStringCellValue());
					...
					scenario[i].setSupply(m, j, k, (scenario[i].getSupply()[m][j][k]+supply));
